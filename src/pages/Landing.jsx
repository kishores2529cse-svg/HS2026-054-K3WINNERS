  ...
  return (
    <div className="space-y-20 pb-16">
      ...
      <section className="relative pt-12 pb-8 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-b from-emerald-50/60 to-transparent -z-10 rounded-3xl" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative bg-white rounded-2xl p-6 shadow-xl border border-slate-200 space-y-4">
                ...
                <div className="bg-slate-900 text-white rounded-xl p-4 relative overflow-hidden">
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="text-[10px] uppercase text-emerald-400 font-bold tracking-wider mb-1">
                        Category: Road Infrastructure
                      </div>
                      <h4 className="font-semibold text-sm text-white">Large Pothole near Main Market Crossing</h4>
                      <p className="text-xs text-slate-400 mt-1 flex items-center gap-1">
                        <MapPin className="w-3 h-3 text-emerald-400" /> Sector 4, MG Road, Ward 12
                      </p>
                    </div>
                ...
                <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3.5 flex items-start gap-3 text-xs text-emerald-900">
                  ...
                  <div>
                    <strong className="font-semibold">AI Routing Engine:</strong>
                ...
                <div className="space-y-2 pt-1">
                  <div className="flex justify-between text-xs font-semibold text-slate-700">
                    ...
                    <span className="text-emerald-600 font-bold">Step 3 of 4</span>
                  </div>
                  <div className="w-full bg-slate-100 rounded-full h-2">
                    <div className="bg-emerald-600 h-2 rounded-full w-3/4 transition-all duration-500" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-xs text-slate-700 font-medium">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Photo upload with location auto-tagging
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Live complaint tracker with stage timeline
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Transparent officer details & completion proof
                  </li>
                </ul>
          ...
          {activeRoleTab === 'officer' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-slate-900 text-white p-6 rounded-xl border border-slate-800 space-y-3">
